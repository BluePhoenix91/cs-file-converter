...
class Program
{
    ...
    static ProcessingOptions GetProcessingOptions()
    {
        ...
        options.RemoveWhitespace = Console.ReadLine().Trim().ToUpper() == "Y";
        return options;
    }
    ...
    static string RemoveRegions(string content)
    {
    ...
    static string OptimizeWhitespace(string content)
    {
